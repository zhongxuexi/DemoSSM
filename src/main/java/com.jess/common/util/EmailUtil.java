...
public class EmailUtil {
    ...
    private static final String USERNAME = "jess.zhong@aliyun.com";
    private static final String PASSWORD = "Zxx@!@686988";
    private static final String EMAILFORM = "jess.zhong@aliyun.com";
